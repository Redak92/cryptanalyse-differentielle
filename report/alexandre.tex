...
\begin{frame}{Le goulot d'étranglement spatial}
    ...
    \begin{block}{Le coût matériel de la détection}
    ...
    \begin{itemize}
        \item \textbf{Taille de l'échantillon :} $2^{n/2} \cdot p^{-1} = 2^{32}$ messages de 32 bits = \textbf{16 Go}.
        \item \textbf{Signatures uniques (Loi $1 - 1/e$) :} $\approx 63,2\,\%$ de l'espace couvert, soit $0,632 \times 2^{32}$ signatures de 32 bits = \textbf{10,8 Go}.
        \item \textbf{Charge utile minimale brute :} $16 \text{ Go} + 10,8 \text{ Go} = \mathbf{26,8 \text{ Go}}$.
    \end{itemize}
